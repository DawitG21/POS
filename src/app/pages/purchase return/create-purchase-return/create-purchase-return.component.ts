...
export class CreatePurchaseReturnComponent implements OnInit {
  ...
  create(purchaseReturn: PurchaseReturnCreate) {
    return lastValueFrom(this.purchaseReturnService.create(purchaseReturn));
  }
  ...
  save() {
    ...
    this.model = new PurchaseReturnCreate();
